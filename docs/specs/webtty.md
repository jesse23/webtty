...
| Client integration (CLI → Web) | Session-scoped publish (`POST /s/:id/publish`, one-shot JSON or streaming NDJSON) + WebSocket subscribe (`GET /s/:id/subscribe`); no extra process or port | [ADR 025](../adrs/025.server.channel.md) | ❌ |
