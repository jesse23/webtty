...
| Client integration (CLI → Web) | Named pub/sub channel on the existing server; CLI agents push JSON, browser UIs subscribe via WebSocket; no extra process or port | [ADR 025](../adrs/025.server.channel.md) | ❌ |
